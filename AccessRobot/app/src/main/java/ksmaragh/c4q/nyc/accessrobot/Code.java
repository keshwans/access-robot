...
public class Code extends AppCompatActivity {
    ...
    private class BluetoothHandler extends Handler {
        ...
        private final Code mActivity;

        public BluetoothHandler(Code activity) {
            mActivity = activity;
        }
...
//                    mConversationArrayAdapter.add(mConnectedDeviceName + ":  " + readMessage);
    ...
    public class myJsInterface {
        ...
        @JavascriptInterface
        public void talkToArduino(String mssg) {
...
//            sendMessage(mssg);
        ...
        public void connectBluetooth() {
            ...
            Intent serverIntent = new Intent(Code.this, DeviceListActivity.class);
